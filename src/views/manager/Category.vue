<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 10px;">
      <el-input prefix-icon="Search" style="width: 300px; margin-right: 10px" placeholder="请输入分类名称查询" v-model="data.name"></el-input>
...
const save = () => {
  request.request({
    ...
    url: data.form.id ? '/category/update' : '/category/add',
    data: data.form
  }).then(res => {
    if (res.code === '200') {
